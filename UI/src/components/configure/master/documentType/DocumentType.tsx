// src/pages/configure-master/DocumentType.tsx
  ...
  const rows = [
    {
      ...
      category: 'Finance',
      subcategory: 'Payroll',
      description: 'Employee payslip and salary details',
      createdBy: 'Admin',
    ...
    },
    {
      ...
      description: 'Job offer documents for new hires',
      createdBy: 'Jane Doe',
    ...
    },
    {
      ...
      description: 'Setup guide for VPN access',
